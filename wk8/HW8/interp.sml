...
fun interp_lazy (env, AST_ID i)          = raise Not_implemented_yet 
  ...
  | interp_lazy (env, AST_LET (x,e1,e2)) = raise Not_implemented_yet
  | interp_lazy (env, AST_ERROR s)       = raise Error s


fun interp_lazy_static (env, AST_ID i) = raise Not_implemented_yet 
