...
|   interp  (env, AST_BOOL b)        = raise Not_implemented
|   interp  (env, AST_ID x  )        = look_up env x 
|   interp  (env, AST_IF (e1,e2,e3)) = raise Not_implemented

|   interp  (env, AST_FUN(x,body))   = raise Not_implemented
...
| interp   (env, AST_APP (e1,e2))   = raise Not_implemented
